...
export const CacheStats: React.FC = () => {
  ...
  if (loading && !stats) return <div className="animate-pulse h-24 bg-gray-100 rounded-2xl" />;
    ...
    <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-gray-900">Image Cache</h3>
        </div>
        <button 
          onClick={fetchStats}
          disabled={loading}
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="p-4 bg-gray-50 rounded-2xl">
          ...
          <p className="text-lg font-bold text-gray-900">{stats.sizeFormatted}</p>
          <p className="text-[10px] text-gray-400">of {stats.limitFormatted}</p>
        </div>
        <div className="p-4 bg-gray-50 rounded-2xl">
          <div className="flex items-center gap-2 text-gray-400 mb-1">
          ...
          <p className="text-lg font-bold text-gray-900">{stats.files.toLocaleString()}</p>
          <p className="text-[10px] text-gray-400">cached images</p>
        </div>
      </div>
